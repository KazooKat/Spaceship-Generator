...
New here? See [docs/quickstart.md](docs/quickstart.md) for a 5-minute getting-started guide. Hit an error? See [docs/troubleshooting.md](docs/troubleshooting.md) for common failures and one-line fixes.
