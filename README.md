...
New here? See [docs/quickstart.md](docs/quickstart.md) for a 5-minute getting-started guide. Want copy-paste recipes? See [docs/recipes.md](docs/recipes.md) for a task-oriented recipe index. Need the output payload shapes? See [docs/output-formats.md](docs/output-formats.md) for the `.litematic` + JSON envelope reference. New to the term jargon? See [docs/glossary.md](docs/glossary.md) for an A-Z definition of recurring project terms. Hit an error? See [docs/troubleshooting.md](docs/troubleshooting.md) for common failures and one-line fixes. Wondering "how do I...?" See [docs/faq.md](docs/faq.md) for the common-question reference. Profiling a refactor? See [docs/bench.md](docs/bench.md) for the bench-script catalog. Hacking on the code? See [docs/contributing.md](docs/contributing.md) for the short development guide.
...
See [docs/cli.md](docs/cli.md) for the full CLI flag reference, or [docs/configuration.md](docs/configuration.md) for a config-by-category index.

- `--preset <role>` — apply a named archetype (corvette, scout, battlecruiser, …); run `--list-presets` to list all (see [docs/presets.md](docs/presets.md) for the full catalog)
